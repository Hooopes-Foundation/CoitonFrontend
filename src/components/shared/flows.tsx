...
import LazyLottie from "./animation";
...
const coitonFlows = [
  {
    ...
    stack: (
      <div className="w-full h-[396px] relative overflow-hidden">
        <LazyLottie
          getAnimationData={() => import("../../assets/lotties/stack.json")}
          loop
          id="browse-property"
          width={120}
          height={396}
          className="size-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-[2.25] -z-10"
        />
      </div>
    ),
  },
  {
    ...
    stack: (
      <div className="w-full h-[397px] relative overflow-hidden">
        <Image
          src="/svgs/buy-token.svg"
          alt=""
          priority
          fill
  ...
  },
  {
    ...
    stack: (
      <div className="w-full h-[400px] relative overflow-hidden">
        <Image
          src="/svgs/earn-returns.svg"
          alt=""
          priority
          fill
          className="size-full object-contain scale-[1.21] ml-4"
        />
      </div>
    ),
  },
...
export default function Flows() {
  ...
  return (
    <div className="mb-28 flex gap-[37px]">
      {/* Sticky section */}
