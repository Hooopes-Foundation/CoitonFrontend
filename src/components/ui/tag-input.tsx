    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex min-h-14 w-full flex-wrap items-center gap-2 rounded-[8px] border border-[#F2F4F7] bg-background px-5 py-4 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative flex h-max items-center gap-1 truncate rounded px-2 aria-disabled:cursor-not-allowed aria-disabled:opacity-50 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground",
              )}
              variant={"secondary"}
            >
          ...
          <Input
            ...
            className={cn(
              "h-auto w-max flex-1 rounded-none border-none p-0 text-base outline-none ring-0 focus-visible:ring-0 focus-visible:ring-offset-0",
