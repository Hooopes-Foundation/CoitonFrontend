  ...
  return (
    <div className="flex h-full items-center justify-center px-4">
      ...
      <div className="w-full max-w-[720px] rounded-[32px] bg-background">
        <div className="flex h-60 w-full items-center justify-center rounded-t-[32px] bg-[#EEFEFB] p-6 md:h-[339px] md:p-0">
          <img
        ...
        <div className="flex flex-col gap-[32px] p-5 md:p-10">
          <div className="flex flex-col gap-2">
            <h4 className="font-sans_bold text-xl text-primary md:whitespace-nowrap md:text-[32px] md:leading-none">
              Connect Your Wallet
            </h4>
            <p className="font-sans_regular text-base text-[#475467] md:text-lg">
          ...
          <div className="mx-auto flex max-w-xl flex-col gap-4">
            <div className="flex items-start gap-4">
              ...
              <p className="-mt-1 flex-1 text-sm font-normal md:text-base">
          ...
          {connectorsInfo.map((connectorInfo) => {
            ...
            return (
              <div
                ...
                className="flex h-[58px] items-center"
              >
                {connector ? (
                  <Button
                  ...
                  >
                    <span>Connect {connectorInfo.name} wallet</span>
                    <svg
                      width="12"
                      height="11"
                      viewBox="0 0 12 11"
